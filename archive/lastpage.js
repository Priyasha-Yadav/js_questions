...
else if (number1 == number2 & number1 > number3) { console.log(number1, 'and', number2, 'are greater') }

else if (number1 == number3 & number1 > number2) { console.log(number1, 'and', number3, 'are greater') }
...
else if (number1 == number2 & number1 > number3) { console.log(number3, 'is lesser') }

else if (number1 == number3 & number1 > number2) { console.log(number1, 'and', number3, 'are lesser') }
...
let number = 25;
for (i = 1; i <= number; i++) {
    if (number % i == 0) { console.log("Factors:", i) }
